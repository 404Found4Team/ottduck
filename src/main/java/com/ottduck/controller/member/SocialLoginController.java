...
// application.properties의 ottduck.oauth.{kakao|google}.* 값(클라이언트 키)만 채우면 바로 동작함.
@Controller
...
public class SocialLoginController {
    ...
    @Value("${ottduck.oauth.kakao.client-id}")
    private String kakaoClientId;
    @Value("${ottduck.oauth.kakao.client-secret:}")
    private String kakaoClientSecret;
    @Value("${ottduck.oauth.kakao.redirect-uri}")
    private String kakaoRedirectUri;

    @Value("${ottduck.oauth.google.client-id}")
    private String googleClientId;
    @Value("${ottduck.oauth.google.client-secret}")
    private String googleClientSecret;
    @Value("${ottduck.oauth.google.redirect-uri}")
    ...
    public String kakaoCallback(@RequestParam(value = "code", required = false) String code,
        ...
        if (email == null || email.isBlank()) {
            ...
            email = "kakao_" + socialKey + "@social.ottduck.local";
        }
        @SuppressWarnings("unchecked")
    ...
    public String googleCallback(@RequestParam(value = "code", required = false) String code,
        ...
        if (email == null || email.isBlank()) {
            email = "google_" + socialKey + "@social.ottduck.local";
        }
